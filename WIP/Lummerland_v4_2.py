#!/usr/bin/env python3
# =============================================================
#  🏝️  LUMMERLAND ISLAND ENERGY MODEL v4.2  – Lummerland + Lummerstadt (Greifswald)
...
# =============================================================
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Lummerland_v4_2_Output")
...
print("=" * 55)
print(" LUMMERLAND v4.2 – modularisiert (Lummerland + Lummerstadt)")
...
fig_a.suptitle("LUMMERLAND v4.2 – Erzeugungsmix, H₂-System & Sektorkopplung",
               fontsize=14, fontweight="bold", color="white", y=0.97)
_path_a = os.path.join(OUTPUT_DIR, "lummerland_v4_2_ergebnisse.png")
...
fig_b.suptitle("LUMMERLAND v4.2 – Kosten, CO₂ & Monte-Carlo Robustheit",
               fontsize=14, fontweight="bold", color="white", y=0.97)
_path_b = os.path.join(OUTPUT_DIR, "lummerland_v4_2_kosten.png")
...
fig_c.suptitle("LUMMERLAND v4.2 – Sektorkopplung, Speicher & Versorgungssicherheit  |  inkl. Lummerstadt",
               fontsize=14, fontweight="bold", color="white", y=0.97)
_path_c = os.path.join(OUTPUT_DIR, "lummerland_v4_2_sektoren.png")
...
ax_map.set_title(
    f"LUMMERLAND v4.2 – Lummerland + Lummerstadt (Greifswald)  |  {'✓ Echte Daten' if DATA_OK else '⚠ Demo-Fallback'}",
...
pdf_path = os.path.join(OUTPUT_DIR, "Lummerland_v4_2_Bericht.pdf")
...
with PdfPages(pdf_path) as pdf:
    ...
    ac.text(0.5, 0.60, "Island Energy Model v4.2 – Lummerland + Lummerstadt", ha="center", fontsize=24, color="white", transform=ac.transAxes)
    ...
    d = pdf.infodict()
    d["Title"]        = "Lummerland Island Energy Model v4.2"
