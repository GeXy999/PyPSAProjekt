...
GRB_LICENSEID_RAW = os.getenv("GRB_LICENSEID", "")

try:
    GRB_LICENSEID = int(GRB_LICENSEID_RAW) if GRB_LICENSEID_RAW else None
except ValueError:
    GRB_LICENSEID = None
    print("⚠ GRB_LICENSEID aus .env ist keine gültige Zahl")
